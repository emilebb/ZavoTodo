/**
 * ============================================
 * ZAVO - Simple Google Map (Sin errores)
 * ============================================
 * 
 * Versión simple que funciona sin errores
 */
...
const SimpleGoogleMap = memo(function SimpleGoogleMap({
  ...
  // ============================================
  // ICONOS PREDEFINIDOS (SIN ERRORES)
  // ============================================

  const getMarkerIcon = (type: string) => {
    // URLs de iconos predefinidos de Google Maps
    const iconUrls = {
      restaurant: 'https://maps.google.com/mapfiles/ms/icons/green-dot.png',
      courier: 'https://maps.google.com/mapfiles/ms/icons/orange-dot.png',
      delivery: 'https://maps.google.com/mapfiles/ms/icons/blue-dot.png',
      user: 'https://maps.google.com/mapfiles/ms/icons/purple-dot.png',
    }

    return iconUrls[type as keyof typeof iconUrls] || iconUrls.restaurant
  }
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        >
          {/* Marcadores con iconos predefinidos */}
          {markers.map((marker) => (
            <Marker
              key={marker.id}
